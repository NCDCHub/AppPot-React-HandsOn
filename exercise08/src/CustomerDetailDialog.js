                        ...
                        <div className="panel-body">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="name" 
                                    value={this.nullToBlank(this.state.values.name)}
                                    onChange={this.handleInputChange}
                                    required="required"/>
                            </div>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="zip" 
                                    value={this.nullToBlank(this.state.values.zip)}
                                    onChange={this.handleInputChange} />
                            </div>
                            <div className="form-group">
                                <label className="control-label" htmlFor="address">住所</label>
                                <input type="text" className="form-control" name="address" 
                                    value={this.nullToBlank(this.state.values.address)}
                                    onChange={this.handleInputChange} />
                            </div>
                            <div className="form-group">
                                <label className="control-label" htmlFor="phone">電話番号</label>
                                <input type="text" className="form-control" name="phone" 
                                    value={this.nullToBlank(this.state.values.phone)}
                                    onChange={this.handleInputChange}
                                    required="required"
                                    pattern="^[0-9]+$" />
                            </div>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="sex" 
                                    value={this.nullToBlank(this.state.values.sex)}
                                    onChange={this.handleInputChange}
                                    required="required"
                                    pattern="^[0-1]+$" />
                            </div>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="serverCreateTime" readOnly="readOnly" 
                                    value={this.nullToBlank(this.state.values.serverCreateTime)}
                                    onChange={this.handleInputChange} />
                            </div>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="serverUpdateTime" readOnly="readOnly" 
                                    value={this.nullToBlank(this.state.values.serverUpdateTime)}
                                    onChange={this.handleInputChange} />
                            </div>
                        </div>
                        ...
                        <div className="panel-footer container-fluid" style={{paddingLeft: 0 + "px", paddingRight: 0 + "px"}}>
                            <div className="row-fluid">
                                <div className="col-md-3">
                                    {(() => {
                                        if (this.props.customer != null && this.props.customer.mode == "edit") {
                                            return <input type="button" className="btn btn-primary btn-block" value="削除" onClick={this.handleDelete} />
                                        }
                                    })()}
                                </div>
